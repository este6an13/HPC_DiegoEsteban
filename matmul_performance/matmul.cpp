...
// EXECUTION: We're going to use 30 iterations in each case.
    ...
    // STRONG SCALING
        ...
        // for S in 10 50 100 200 500 1000 2000 3000 4000; ./matmul 1 $S 30 2> /dev/null > strong_eigen.txt; done
        
        // WITH EIGEN WITH O3
        // for S in 10 50 100 200 500 1000 2000 3000 4000; ./matmul_O3 1 $S 30 2> /dev/null > strong_eigen_O3.txt; done

        // WITHOUT EIGEN WITHOUT O3
        // for S in 10 50 100 200 500 1000 2000 3000 4000; ./matmul 0 $S 30 2> /dev/null > strong_simple.txt; done
        
        // WITHOUT EIGEN WITH O3
        // for S in 10 50 100 200 500 1000 2000 3000 4000; ./matmul_O3 0 $S 30 2> /dev/null > strong_simple_O3.txt; done

    // WEAK SCALING

        // WITH EIGEN WITH 03
        // for th in seq 16; OMP_NUM_THREADS=$th ./matmul_O3_OPM 1 4000 30 2> /dev/null > weak_eigen_O3_OMP.txt: done
